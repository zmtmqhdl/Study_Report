...
## 🖥️ Study Report
Android Studio의 Virtual Device에서 스터디 팀원들의 APK파일을 빠르게 다운받고 실행해보기 위한 Android App
...
## ✏️ 배운 내용
- Firebase서버를 구축하고 앱과 연결해보았습니다.
- Kotlin을 사용하고 학습하였습니다.
- 기기의 내부저장소에 접근하여 파일을 업로드하고, 게시판의 앱을 다운로드하는 방법을 배웠습니다.
